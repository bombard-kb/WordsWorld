...
contract PHRASE is ERC721Full {
    ...
    function add(uint256[] memory tokens) public payable {
        ...
        {
            uint256 word_id = tokens[i];
            
            address payable word_owner = address(uint160(wordContract.ownerOf(word_id)));
            
            require(word_owner != address(0x0), "The word token must exist");
